...
export declare const writeFileAtomic: (arg1: string, arg2: string | Buffer, arg3: wfa.Options) => Promise<void>;
export declare const writeFileAtomicSync: typeof wfa.sync;
export { makeDir };
/**
