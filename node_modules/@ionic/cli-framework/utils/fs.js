...
exports.writeFileAtomic = promise_1.promisify(wfa);
exports.writeFileAtomicSync = wfa.sync;
/**
...
function readDir(dir, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.recursive) {
            const klaw = yield Promise.resolve().then(() => require('klaw'));
            ...
            try {
                return yield exports.fsReadDir(dir);
            }
            catch (e) {
                return [];
            }
...
function findBaseDirectory(dir, file) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const d of path_1.compilePaths(dir)) {
