    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_11__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].firebase, 'angular-auth-firebase'),
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signInWithGoogle = function () {
        return this._firebaseAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider()).then(function (res) {
    ...
    AuthService.prototype.createUser = function (credentials) {
        return firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().createUserWithEmailAndPassword(credentials.email, credentials.senha).then(function (res) {
            console.log(res);
            var usuario = firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, plt, _firebaseAuth, loadingController) {
        var _this = this;
    ...
    AuthenticationService.prototype.presentLoading = function () {
    ...
    AuthenticationService.prototype.signWithEmail = function (credentials) {
        var _this = this;
        this.presentLoading();
        return this._firebaseAuth.auth
            .signInWithEmailAndPassword(credentials.email, credentials.password)
            .then(function (data) {
            _this.storage.set(TOKEN_KEY, 'Bearer 1234567').then(function () {
                _this.authenticationState.next(true);
            });
        });
    };
    AuthenticationService.prototype.signInWithGoogle = function () {
        var _this = this;
        return this._firebaseAuth.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_5__["auth"].GoogleAuthProvider()).then(function () {
            _this.storage.set(TOKEN_KEY, 'Bearer 1234567').then(function () {
                _this.authenticationState.next(true);
            });
        });
...
var UserService = /** @class */ (function () {
    function UserService(_af) {
        this._af = _af;
        this._userCollection = _af.collection('items', function (x) { return x.orderBy('name', 'asc'); });
    }
    UserService.prototype.getUsers = function () {
        var _this = this;
        this.users = this._userCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (actions) {
    ...
    UserService.prototype.createUsers = function (user) {
        console.log('dados: ', user);
        return this._userCollection.add(user).then(function (data) {
            console.log('Documento cadastrado com sucesso!');
        }).catch(function (error) {
            console.error('Erro ao cadastrar o usuário: ', error);
        });
    };
    UserService.prototype.deleteUsers = function (key) {
        return this._userCollection.doc(key).delete().then(function (data) {
...
module.exports = __webpack_require__(/*! C:\Users\natanPolly\Documents\Projetos-Ionic\vemComigo2\src\main.ts */"./src/main.ts");
